...
<body>
    ...
    <!-- Doaa Talib Abu Shaar 220181611 -->
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
               <span>Card CVV</span>
                <input type="tel" placeholder="Card CVV" name="card CVV">
            </div> 
            <div class="inputBox">
            <span>city</span>
         ...
         <div class="inputBox">
            ...
            <div class="inputBox">
                  ...
                  <input type="text" placeholder="e.g. Month: 1" name="Month" required>
            </div>
            <div class="inputBox">
                  <span>Expiration Year</span>
                  <input type="text" placeholder="e.g. Year: 2022" name="Year" required>
            </div>   
